...
function registerJournalPostType()
{
    $labels = [
        'name'                  => _x('Journal', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Journal', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Journal', 'flynt'),
        'name_admin_bar'        => __('Journal', 'flynt'),
    ...
    $args = [
        'label'                 => __('Journal', 'flynt'),
        'description'           => __('Journal Description', 'flynt'),
        'labels'                => $labels,
...
add_action('init', '\\Flynt\\CustomPostTypes\\registerJournalPostType');
