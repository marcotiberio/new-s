...
function registerJournalCategoryTaxonomy()
{
    $labels = [
    ...
    register_taxonomy('journal-category', ['journal'], $args);
}

add_action('init', 'Flynt\\CustomTaxonomies\\registerJournalCategoryTaxonomy');
