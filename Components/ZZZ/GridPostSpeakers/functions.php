...
namespace Flynt\Components\GridPostSpeakers;
...
add_filter('Flynt/addComponentData?name=GridPostSpeakers', function ($data) {
    $postType = POST_TYPE;
...
{
    return [
        'name' => 'GridPostSpeakers',
        'label' => 'Grid: Post Speakers',
        'sub_fields' => [
            [
...
Options::addTranslatable('GridPostSpeakers', [
    [
