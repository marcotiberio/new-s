            ...
            [
                ...
                'sub_fields' => [
                    ...
                    [
                        ...
                        'type' => 'button_group',
                        'choices' => [
                            'col-start-1 md:col-start-1' => sprintf('<p>1</p>', __('1', 'flynt')),
                            'col-start-1 md:col-start-2' => sprintf('<p>2</p>', __('2', 'flynt')),
                            'col-start-1 md:col-start-3' => sprintf('<p>3</p>', __('3', 'flynt')),
                            'col-start-1 md:col-start-4' => sprintf('<p>4</p>', __('4', 'flynt')),
                            'col-start-1 md:col-start-5' => sprintf('<p>5</p>', __('5', 'flynt')),
                            'col-start-1 md:col-start-6' => sprintf('<p>6</p>', __('6', 'flynt')),
                            'col-start-1 md:col-start-7' => sprintf('<p>7</p>', __('7', 'flynt')),
                            'col-start-1 md:col-start-8' => sprintf('<p>8</p>', __('8', 'flynt')),
                            'col-start-1 md:col-start-9' => sprintf('<p>9</p>', __('9', 'flynt')),
                            'col-start-1 md:col-start-10' => sprintf('<p>10</p>', __('10', 'flynt')),
                            'col-start-1 md:col-start-11' => sprintf('<p>11</p>', __('11', 'flynt')),
                            'col-start-1 md:col-start-12' => sprintf('<p>12</p>', __('12', 'flynt'))
                        ],
                        'wrapper' => [
                            'width' => 50
                        ],
