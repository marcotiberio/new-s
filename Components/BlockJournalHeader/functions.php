...
namespace Flynt\Components\BlockJournalHeader;

use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockJournalHeader', function ($data) {
...
Options::addTranslatable('BlockJournalHeader', [
    [
